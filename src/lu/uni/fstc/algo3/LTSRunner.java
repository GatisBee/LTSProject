...
import lu.uni.fstc.algo3.view.Gui;
...
public class LTSRunner {
		...
		while (true) {
			...
			if (line != null) {
				...
				if (line.equals("start")) {
					...
					System.out
							.println("Creating and printing monthly bills...");
	...
	public static void generateNumberPlates() {
		...
		System.out
				.print("... finished writing , you can check the results ...");
		// System.exit(0);
	}
}
