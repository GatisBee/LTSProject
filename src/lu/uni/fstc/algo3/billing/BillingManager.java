...
public class BillingManager {
    ...
    public List<Bill> createMonthlyBills(YearMonth yearMonth) {
         ...
         */
        Filter.removeConflicts((ArrayList<ScanEntry>) monthlyScans);
        /*
        ...
        for (NumberPlate p : plates) {
             ...
             */
            List<ScanEntry> scansAllDirections = (List<ScanEntry>) Filter.filterByNumberPlate(monthlyScans, p);
            /*
    ...
    public List<Bill> createMonthlyBills() {
         ...
         */
        List<ScanEntry> thisMonthScans = (ArrayList<ScanEntry>) Filter.filterByYearMonth(lts.getAllScans(), yearMonth);
        /*
        Sort this array by time.
         */
        ...
        Eliminate duplicate scans if any are present
         */
        Filter.removeConflicts((ArrayList<ScanEntry>) thisMonthScans);
        ...
        for (NumberPlate p : plates) {
             ...
             */
            List<ScanEntry> scansAllDirections = (List<ScanEntry>) Filter.filterByNumberPlate(thisMonthScans, p);
            /*
