...
/**
 * A bill that will be created for the usage of the road network. Billing policy
 * is defined in billing manager. Created by Gatis on 27/03/2015.
 */
public class Bill {
	/**
	...
	public Bill(double ammountToPay, Vehicle vehicle,
			VehicleOwner vehicleOwner, Address address) {
		super();
